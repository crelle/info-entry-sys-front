...
<script>
import { getPie3D, getParametricEquation } from '@/util/chart/chart.js' //工具类js，页面路径自己修改
...
export default {
  ...
  methods: {
    ...
    initChart () {
      ...
      this.option = getPie3D(this.optionData, 0.8, 200, 28, 36, 0.7)
...
.chart-container {
  ...
  .bg {
    ...
    background-image: url('./images/uihomepage/pieBase.png');
