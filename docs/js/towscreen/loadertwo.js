...
numShow[0].children[1].children[0].innerHTML = 576;
numShow[1].children[1].children[0].innerHTML = 498;
numShow[2].children[1].children[0].innerHTML = 150;
numShow[3].children[1].children[0].innerHTML = 4883;
